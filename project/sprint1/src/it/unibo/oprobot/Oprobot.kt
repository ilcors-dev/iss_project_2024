		...
		return { //this:ActionBasciFsm
				...
				state("execGetRp") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("getrp(TARGETX,TARGETY)"), Term.createTerm("getrp(X,Y)"), 
								...
								publish(MsgUtil.buildEvent(name,"mqtt_info","moving_to_WasteIn_port").toString(), "it.unib0.iss.wis" )   
								request("moverobot", "moverobot($X,$Y)" ,"basicrobot" )  
						}
						//genTimer( actor, state )
					}
				...
				state("getRpOk") { //this:State
					action { //it:State
						...
						publish(MsgUtil.buildEvent(name,"mqtt_info","collected_RP_from_WasteIn_port").toString(), "it.unib0.iss.wis" )   
				...
				state("execDepositRp") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("depositrp(TARGETX,TARGETY)"), Term.createTerm("depositrp(X,Y)"), 
								...
								publish(MsgUtil.buildEvent(name,"mqtt_info","moving_to_BurnIn_port").toString(), "it.unib0.iss.wis" )   
								request("moverobot", "moverobot($X,$Y)" ,"basicrobot" )  
						}
						//genTimer( actor, state )
					}
				...
				state("depositRpOk") { //this:State
					action { //it:State
						...
						publish(MsgUtil.buildEvent(name,"mqtt_info","deposited_RP_in_BurnIn_port").toString(), "it.unib0.iss.wis" )   
				...
				state("execExtractAsh") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("extractash(TARGETX,TARGETY)"), Term.createTerm("extractash(X,Y)"), 
								...
								publish(MsgUtil.buildEvent(name,"mqtt_info","moving_to_BurnOut_port").toString(), "it.unib0.iss.wis" )   
								request("moverobot", "moverobot($X,$Y)" ,"basicrobot" )  
						}
						//genTimer( actor, state )
					}
				...
				state("extractAshOk") { //this:State
					action { //it:State
						...
						publish(MsgUtil.buildEvent(name,"mqtt_info","collected_ash_from_BurnOut_port").toString(), "it.unib0.iss.wis" )   
				...
				state("execDepositAsh") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("depositash(TARGETX,TARGETY)"), Term.createTerm("depositash(X,Y)"), 
								...
								publish(MsgUtil.buildEvent(name,"mqtt_info","moving_to_AshOut_port").toString(), "it.unib0.iss.wis" )   
								request("moverobot", "moverobot($X,$Y)" ,"basicrobot" )  
						}
						//genTimer( actor, state )
					}
				...
				state("depositAshOk") { //this:State
					action { //it:State
						...
						publish(MsgUtil.buildEvent(name,"mqtt_info","deposited_ash_in_AshOut_port").toString(), "it.unib0.iss.wis" )   
